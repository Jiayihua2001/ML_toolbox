...
class MLP4:
    ...
    def forward(self, A):
        ...
        return A  # Return the final output, not the list of all activations
    ...
    def backward(self, dLdA):
        ...
        for i in reversed(range(L)):
            dLdA = self.layers[i].backward(dLdA)  # TODO: Update dLdA, not self.dLdA

            if self.debug:
                self.dLdA = [dLdA] + self.dLdA

        return dLdA  # Return the final gradient, not self.dLdA
