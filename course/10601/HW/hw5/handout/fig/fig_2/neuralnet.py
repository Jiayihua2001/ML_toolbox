...
class Linear:
    def __init__(self, input_size: int, output_size: int,
        ...
        self.W=weight_init_fn((output_size,input_size+1))[:,1:]
    ...
    def step(self) -> None:
        ...
        # np.savetxt('parameter.csv',p,delimiter=',')
        return 
...
def main():
    ...
    # #Fig 1
    # with open('n_hid.txt','a') as f:
    #     f.write(f'{n_hid},{train_losses[-1]},{test_losses[-1]}\n')
